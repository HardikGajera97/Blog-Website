...
<body>
    ...
    <div class="blog container" id="Blog">
        ...
        <div class="row r1">
            ...
            <div class="col-md-4" id="card-p">
                <div class="card m-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="crudbtn">
                            <button class="btn" style="background-color: #dd7973;"><a href="view.php?srno='.$fetch['srno'].'" class="text-light text-decoration-none">View</a></button>
                            <button class="btn btn-primary"><a href="edit.php?srno='.$fetch['srno'].'" class="text-light text-decoration-none">Update</a></button>
                            <a href="./delete.php?srno='.$fetch['srno'].'"  class="btn delbtn btn-primary">Delete</a>
                        </div>
            ...
            <div class="row r2">
                <div class="col-md-12">
                    <button class="crbtn" onclick="Creatblog()">
                        <b class="text"> + Create your blog</b>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div id="About" class="about container mt-2">
        <h2>About Us</h2>
